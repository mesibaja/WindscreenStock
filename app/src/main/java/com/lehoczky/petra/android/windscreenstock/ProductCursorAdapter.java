...
public class ProductCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        final int idColumnIndex = cursor.getColumnIndex(WindscreenContract.WindscreenEntry._ID);
    ...
    private View.OnClickListener openProductDetailsAction(final int productId) {
        return new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Uri contentProductUri = ContentUris.withAppendedId(WindscreenContract.WindscreenEntry.CONTENT_URI, productId);
